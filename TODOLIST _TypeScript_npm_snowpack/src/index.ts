...
//W tych liniach kodu funkcja loadTasks jest definiowana. Jest ona odpowiedzialna za odczytanie danych z pamięci przeglądarki za pomocą metody localStorage.getItem. Metoda ta pobiera dane z pamięci przeglądarki na podstawie podanego klucza (w tym przypadku 'TASKS'). Jeśli nie ma danych o podanym kluczu, metoda zwraca wartość null.

//Następnie w kodzie, jest sprawdzany czy taskJson jest równe null, jeśli tak to zwracana jest pusta tablica. W przeciwnym razie dane są parsowane z formatu JSON na JavaScriptowy format za pomocą metody JSON.parse i zwracane jako tablica tasków.
